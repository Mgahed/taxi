...
class AdminViewController extends BaseController
{
    ...
    public function driverPrfDashboardView(Driver $driver)
    {
        ...
        //card
        $totalTrips = Requests::where('driver_id',$driver->id)->companyKey()->whereIsCompleted(true)->count();
        $todayTrips = Requests::where('driver_id',$driver->id)->companyKey()->whereIsCompleted(true)->whereDate('trip_start_time',$today)->count();
        ...
        //overall trips
        $total_completedTrips = Requests::companyKey()->where('driver_id',$driver->id)->whereIsCompleted(true)->count();
        $total_cancelledTrips = Requests::companyKey()->where('driver_id',$driver->id)->whereIsCancelled(true)->count();
